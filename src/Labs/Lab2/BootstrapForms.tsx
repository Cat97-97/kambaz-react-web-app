  ...
  return (
    <div>
      ...
      <div id="wd-css-styling-switches">
        ...
        <Form.Check type="switch" checked id="wd-switch-2"
          label="Checked switch checkbox input" readOnly/>
        <Form.Check type="switch" disabled id="wd-switch-3"
          label="Unchecked disabled switch checkbox input"/>
        <Form.Check type="switch" checked disabled id="wd-switch-4"
